...
import com.example.accountservice.controller.DTO.AccountRequestDTO;
import com.example.accountservice.controller.DTO.AccountResponseDTO;
...
public class AccountController {
    ...
    public  AccountResponseDTO updateAccount (@PathVariable Long accountId, @RequestBody AccountRequestDTO accountRequestDTO) {
        return new AccountResponseDTO(accountService.accountUpdate(accountId, accountRequestDTO.getName(), accountRequestDTO.getEmail(),
